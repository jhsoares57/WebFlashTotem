...
/* PROCEDURE PARA BUSCAR AS PALESTRA PARA EDIÇÃO*/
/*DATA DE CRIAÇÃO 28/04/2019 AUTOR= HUGO BARROS*/

CREATE PROCEDURE FL_PALESTRA_SEL
@ID_PALESTRA INT
AS
SELECT ID_PALESTRA,TITULO,DESCRICAO,PALESTRANTE,DATA_PALESTRA,HORA_PALESTRA,ENDERECO_PALESTRA
 FROM TB_PALESTRA
WHERE ID_PALESTRA = @ID_PALESTRA
